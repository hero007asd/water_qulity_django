...
function com(){
	...
	$(".p_left").append("<img src='../../site_media/img/004.jpg' width='980' height='840' border='0' usemap='#Map' style='z-index:0;'/><map name='Map' id='Map'>"
			  	+" <area shape='poly' coords='412,107,424,131,432,146,431,159,423,171,428,181,435,189,439,202,445,212,452,220,449,229,445,237,430,238,420,244,424,247,432,247,440,249,453,254,460,263,454,273,441,277,431,283,421,288,407,279,386,267,363,267,337,273,314,267,302,256,290,249,281,236,274,219,267,207,259,198,260,186,299,147,321,131,344,116,361,109,361,111' href='#' title='嘉定区' />"
			    +"<area shape='poly' coords='363,269,361,277,368,286,373,295,381,305,387,309,398,308,408,316,416,327,422,338,411,342,398,347,388,354,379,362,368,367,354,370,342,368,336,361,325,354,313,357,305,365,299,375,289,385,277,391,263,385,253,380,241,378,235,385,237,394,246,404,249,412,249,420,240,424,226,420,218,418,220,431,226,438,224,450,220,469,215,489,208,502,197,505,183,499,177,497,167,506,162,517,157,528,141,523,131,519,127,514,122,505,127,494,131,479,130,465,124,457,109,454,97,454,84,458,73,460,62,461,50,458,48,450,50,439,54,425,58,414,57,401,51,392,41,388,32,386,28,377,31,367,49,358,65,361,75,364,86,356,94,352,105,355,117,357,131,358,143,359,155,355,165,349,174,354,183,359,192,361,194,348,197,342,210,345,218,346,219,323,216,307,216,290,217,277,215,268,210,263,215,257,230,251,239,247,260,253,277,253,291,252,303,261,317,270,330,276,350,273,361,269' href='#' title='青浦区'/>"
		...
		success:function(data){
			...
			for ( var y = 0; y < json['corp_info'].length; y++) {
				...
				if((json['corp_info'][y]['corp_ph'])>=5&&(json['corp_info'][y]['corp_ph'])<=9){
					content+="<tr><td align='center' background='../../site_media/img/007.png' class='line001'>"+json['corp_info'][y]['corp_name']+"</td><td align='center' background='../../site_media/img/007.png' class='line001'>"+json['corp_info'][y]['corp_ph']+"</td><td align='center' background='../../site_media/img/007.png' class='line001'>"+json['corp_info'][y]['corp_conductivity']+"</td><td align='center' background='../../site_media/img/007.png' class='line001'>"+json['corp_info'][y]['corp_DO']+"</td><td align='center' background='../../site_media/img/007.png' class='line001'>"+json['corp_info'][y]['corp_rc']+"</td><td align='center' background='../../site_media/img/007.png' class='line001'>"+json['corp_info'][y]['corp_turbidity']+"</td><td align='center' background='../../site_media/img/007.png' class='line001'>"+json['corp_info'][y]['corp_temp']+"</td></tr>";
				}else{
					content+="<tr><td>"+json['corp_info'][y]['corp_name']+"</td><td style='color:red'>"+json['corp_info'][y]['corp_ph']+"</td><td>"+json['corp_info'][y]['corp_conductivity']+"</td><td>"+json['corp_info'][y]['corp_DO']+"</td><td>"+json['corp_info'][y]['corp_rc']+"</td><td>"+json['corp_info'][y]['corp_turbidity']+"</td><td>"+json['corp_info'][y]['corp_temp']+"</td></tr>";
				}
			}
		...
		success:function(data){
			...
			for ( var y = 0; y < json['area_info'].length; y++) {
				...
				if((json['area_info'][y]['corp_ph'])>=5&&(json['area_info'][y]['corp_ph'])<=9){
					content+="<tr><td align='center' background='../../site_media/img/007.png'>"+json['area_info'][y]['areaName']+"</td><td align='center' background='../../site_media/img/007.png'>"+json['area_info'][y]['area_ph']+"</td><td align='center' background='../../site_media/img/007.png'>"+json['area_info'][y]['area_conductivity']+"</td><td align='center' background='../../site_media/img/007.png'>"+json['area_info'][y]['area_DO']+"</td><td align='center' background='../../site_media/img/007.png'>"+json['area_info'][y]['area_rc']+"</td><td align='center' background='../../site_media/img/007.png'>"+json['area_info'][y]['area_turbidity']+"</td><td align='center' background='../../site_media/img/007.png'>"+json['area_info'][y]['area_temp']+"</td></tr>";
				}else{
					content+="<tr><td align='center' background='../../site_media/img/008.png'>"+json['area_info'][y]['areaName']+"</td><td align='center' background='../../site_media/img/008.png'>"+json['area_info'][y]['area_ph']+"</td><td align='center' background='../../site_media/img/008.png'>"+json['area_info'][y]['area_conductivity']+"</td><td align='center' background='../../site_media/img/008.png'>"+json['area_info'][y]['area_DO']+"</td><td align='center' background='../../site_media/img/008.png'>"+json['area_info'][y]['area_rc']+"</td><td align='center' background='../../site_media/img/008.png'>"+json['area_info'][y]['area_turbidity']+"</td><td align='center' background='../../site_media/img/008.png'>"+json['area_info'][y]['area_temp']+"</td></tr>";
				}
			}
			content+="</table></td></tr></table>";
